...
fun EditProfileScreen(
    navController: NavHostController, userEntityViewModel: UserEntityViewModel,
    ...
    var firstName by remember { mutableStateOf(TextFieldValue((currentUser.value?.firstName!!))) }
    var firstNameError by remember { mutableStateOf(false) }
    var lastName by remember { mutableStateOf(TextFieldValue((currentUser.value?.lastName!!))) }
    var lastNameError by remember { mutableStateOf(false) }
    var postalCode by remember { mutableStateOf(TextFieldValue((currentUser.value?.postalCode!!))) }
    var postalCodeError by remember { mutableStateOf(false) }
    var userName by remember { mutableStateOf(TextFieldValue((currentUser.value?.username!!))) }
    var userNameError by remember { mutableStateOf(false) }
    var phone by remember { mutableStateOf(TextFieldValue((currentUser.value?.phone!!))) }
    var phoneError by remember { mutableStateOf(false) }
    var address by remember { mutableStateOf(TextFieldValue((currentUser.value?.address!!))) }
                ...
                if (isLoading) {
                    ...
                    Button(
                        onClick = {
                            ...
                            if (userNameError || firstNameError || lastNameError || phoneError ||
                            ...
                            isLoading = true
                            userViewModel.update(user) { response ->
                                if (response.status == "OK") {
                                    var userEntity = user.convertToUserEntity()
